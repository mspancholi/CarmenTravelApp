...
class Games extends Component {
    ...
    jail = () => {
        ...
        if (this.state.statusColor === "success") {
            return (<div>
                 <img src="/images/carmeninjail.png" alt="" align="middle" style={{ "width": "400px", "height": "500px" }}>
               </img>

            </div>
            );
        }
        return <img src="/images/carmenlost.jpg" alt="" align="middle" style={{ "width": "400px", "height": "500px" }}>
        </img>
    }
